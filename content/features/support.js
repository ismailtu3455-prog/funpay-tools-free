...
function _renderBubble(c, myUsername) {
    ...
    if (!isMe) {
        ...
        av.style.cssText = `width:28px;height:28px;border-radius:50%;flex-shrink:0;background:var(--fpt-bg, #ffffff);font-size:11px;font-weight:600;color:#e53935;display:flex;align-items:center;justify-content:center;`;
        if (c.avatarUrl) {
...
function initTicketsTab() {
    ...
    replyBtn?.addEventListener('mouseleave', () => replyBtn.style.background = '#e53935');
