    ...
    if (q.type === 'yesno') {
        ...
        ['Да', 'Нет'].forEach(opt => {
            ...
            btn.addEventListener('click', () => {
                ...
                btn.style.borderColor = '#e53935'; btn.style.background = 'rgba(27,117,187,0.16)'; btn.style.color = '#4a9fd4';
        ...
        ta.addEventListener('focus', () => ta.style.borderColor = '#e53935');
...
function auditShowResults(recs) {
    ...
    el.innerHTML = `
        ...
        ${section('🔍 Видимость в поиске', recs.visibility, '#e53935')}
