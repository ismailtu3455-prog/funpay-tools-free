...
function createMainPopup() {
    if (!document.getElementById('fp-popup-extra-styles')) {
        ...
        s.textContent = `
            ...
            .fp-tools-site-link::after{content:'';position:absolute;left:0;bottom:-2px;width:0;height:2px;background:linear-gradient(90deg,#e53935,#4a9fd4);transition:width .3s ease;border-radius:2px;}
            .fp-tools-site-link:hover{background:linear-gradient(90deg,#e53935,#4a9fd4,#e53935);background-size:200%;-webkit-background-clip:text;-webkit-text-fill-color:transparent;background-clip:text;animation:fp-shimmer 1.2s linear infinite;}
            ...
            .fp-wallpaper-card:hover{box-shadow:0 0 0 2px #e53935,0 4px 16px rgba(27,117,187,.3);}
            ...
            .fp-site-footer-link:hover{background:rgba(27,117,187,.12);border-color:#e53935;color:#a09af8;transform:translateY(-1px);box-shadow:0 4px 12px rgba(27,117,187,.2);}
    ...
    toolsPopup.innerHTML = `
        <div class="fp-tools-header">
            <h2 class="fp-tools-title-wrap"><a href="https://t.me/funpayfreetools" target="_blank" class="fp-tools-site-link">FunPay Free Tools</a><button type="button" id="fptAccentBtn" class="fpt-accent-btn" title="Цвет акцента" aria-label="Цвет акцента"><svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M12 3a9 9 0 0 0 0 18c.83 0 1.5-.67 1.5-1.5 0-.39-.15-.74-.39-1.01-.23-.26-.36-.6-.36-.99 0-.83.67-1.5 1.5-1.5H16a5 5 0 0 0 5-5c0-4.42-4.03-8-9-8Z" stroke="currentColor" stroke-width="1.6" stroke-linejoin="round"/><circle cx="7.5" cy="11.5" r="1.1" fill="currentColor"/><circle cx="10.5" cy="7.5" r="1.1" fill="currentColor"/><circle cx="15" cy="8" r="1.1" fill="currentColor"/><circle cx="16.8" cy="12" r="1.1" fill="currentColor"/></svg><input type="color" id="fptAccentInput" class="fpt-accent-input" value="#e53935" aria-hidden="true" tabindex="-1"></button></h2>
            <div class="fp-tools-social">
                <a class="fp-tools-social-btn" href="https://t.me/funpayfreetools" target="_blank" rel="noopener" title="Telegram" aria-label="Telegram"><img class="fp-tools-social-ico" data-icon="telegram" alt="Telegram"></a>
                <a class="fp-tools-social-btn" href="https://github.com/funpay-tools-free" target="_blank" rel="noopener" title="GitHub" aria-label="GitHub"><svg viewBox="0 0 24 24" fill="currentColor" class="fp-tools-social-ico"><path d="M12 2C6.477 2 2 6.484 2 12.017c0 4.425 2.865 8.18 6.839 9.504.5.092.682-.217.682-.483 0-.237-.008-.868-.013-1.703-2.782.605-3.369-1.343-3.369-1.343-.454-1.158-1.11-1.466-1.11-1.466-.908-.62.069-.608.069-.608 1.003.07 1.531 1.032 1.531 1.032.892 1.53 2.341 1.088 2.91.832.092-.647.35-1.088.636-1.338-2.22-.253-4.555-1.113-4.555-4.951 0-1.093.39-1.988 1.029-2.688-.103-.253-.446-1.272.098-2.65 0 0 .84-.27 2.75 1.026A9.564 9.564 0 0112 6.844c.85.004 1.705.115 2.504.337 1.909-1.296 2.747-1.027 2.747-1.027.546 1.379.202 2.398.1 2.651.64.7 1.028 1.595 1.028 2.688 0 3.848-2.339 4.695-4.566 4.943.359.309.678.92.678 1.855 0 1.338-.012 2.419-.012 2.747 0 .268.18.58.688.482A10.019 10.019 0 0022 12.017C22 6.484 17.522 2 12 2z"></path></svg></a>
            </div>
            ...
            <main class="fp-tools-content">
                    ...
                    <div id="fptCustomSoundBlock" style="margin-top:12px;background:var(--fptm-surface-2, #0e0f16);border:1px solid var(--fptm-border, #1e2030);border-radius:10px;padding:14px;display:none;">
                        ...
                        <div id="fptCustomSoundEditor" style="display:none;margin-top:8px;">
                            <div id="fptWaveWrap" style="position:relative;height:64px;background:var(--fptm-surface-2, #070810);border:1px solid var(--fptm-border, #22253a);border-radius:8px;overflow:hidden;user-select:none;cursor:pointer;">
                                ...
                                <div id="fptWaveSel" style="position:absolute;top:0;bottom:0;background:rgba(27,117,187,0.22);border-left:2px solid #e53935;border-right:2px solid #e53935;box-sizing:border-box;"></div>
                ...
                <div class="fp-tools-page-content" data-page="accounts">
                    ...
                    <div class="support-promo" style="background: rgba(27,117,187,0.08); border-color: rgba(27,117,187,0.25); margin-bottom: 20px;">
                        <span class="nav-icon material-symbols-rounded" style="color: #e53935;">info</span>
                    ...
                    <div class="fpt-appx">
                        ...
                        <div class="fpt-appx-block">
                            ...
                            <div class="fpt-seg fpt-seg-fill" data-fpt-opt="fill">
                                <button type="button" data-val="solid" title="Сплошная"><span class="fpt-fill-prev" style="background:#e53935;"></span><span class="fpt-fill-name">Сплошная</span></button>
                                ...
                                <button type="button" data-val="outline" title="Контур"><span class="fpt-fill-prev" style="background:transparent;border:2px solid #e53935;"></span><span class="fpt-fill-name">Контур</span></button>
                                <button type="button" data-val="ghost" title="Призрачная"><span class="fpt-fill-prev" style="background:transparent;border:1px dashed #e53935;"></span><span class="fpt-fill-name">Призрак</span></button>
                            </div>
                        </div>
                        ...
                        <div class="fpt-appx-block">
                            ...
                            <div id="fpt-appearance-preview" class="chat-buttons-container" data-fpt-shape="rounded" data-fpt-size="m" data-fpt-fill="solid" data-fpt-align="center" data-fpt-fullwidth="0" data-fpt-uppercase="0" data-fpt-compact="0">
                                <button type="button" class="chat-template-btn" style="background-color:var(--fpt-accent,#e53935);--btn-color:var(--fpt-accent,#e53935);">Приветствие</button>
                                <button type="button" class="chat-template-btn" style="background-color:#FF6B6B;--btn-color:#FF6B6B;">Спасибо за заказ</button>
                                <button type="button" class="custom-chat-template-btn" style="background-color:var(--fpt-accent,#e53935);--btn-color:var(--fpt-accent,#e53935);">Свой шаблон</button>
                            </div>
                        </div>
                    </div>
                    </div>
                ...
                <div class="fp-tools-page-content" data-page="theme">
                    ...
                    <div id="fp-wallpaper-carousel" style="position:relative;width:100%;aspect-ratio:16/9;border-radius:8px;overflow:hidden;background:var(--fptm-surface-2, #0e0f16);contain:layout style paint;">
                        ...
                        <div id="fp-wp-loader" style="position:absolute;inset:0;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:6px;">
                            ...
                            <div style="width:60px;height:3px;background:var(--fptm-surface, #1e2030);border-radius:2px;overflow:hidden;"><div id="fp-wp-bar" style="height:100%;width:0%;background:#e53935;transition:width .15s linear;border-radius:2px;"></div></div>
                            <span id="fp-wp-pct" style="font-size:10px;color:#4a4f68;">0%</span>
                        </div>
                        <button id="fp-wp-apply-cur" style="position:absolute;top:6px;right:6px;background:var(--fpt-accent, #e53935);border:none;color:#fff;font-size:11px;font-weight:600;padding:4px 10px;border-radius:12px;cursor:pointer;z-index:2;display:none;">Применить</button>
                    </div>
                    <div id="fp-wp-desc" style="font-size:12px;color:#9aa0b8;margin:6px 0 2px;line-height:1.4;min-height:16px;"></div>
                    <div style="font-size:13px;color:var(--fptm-text, #e2e8f0);margin:8px 0 16px;line-height:1.4;text-align:center;background:var(--fptm-surface, rgba(255,255,255,0.05));padding:10px;border-radius:8px;border:1px solid var(--fptm-border, rgba(255,255,255,0.1));">
                        Добавь свой фон в ТГ боте <a href="https://t.me/funpayfreetoolsbot" target="_blank" rel="noopener noreferrer" style="color:var(--fptm-accent, #e53935);font-weight:bold;text-decoration:none;">@funpayfreetoolsbot</a>.
                        <br>
                        <span style="font-size:11px;color:var(--fptm-muted, #94a3b8);opacity:0.8;">После добавления он добавится в этот список</span>
                    </div>
                    <div class="template-container">
                    ...
                    <div class="template-container color-input-grid">
                        <div><label for="themeColor1">Основной цвет:</label><input type="color" id="themeColor1" class="theme-color-input" value="#e53935"></div>
                        <div><label for="themeColor2">Акцентный цвет:</label><input type="color" id="themeColor2" class="theme-color-input" value="#e53935"></div>
                        <div><label for="themeContainerBgColor">Фон блоков:</label><input type="color" id="themeContainerBgColor" class="theme-color-input" value="#e53935"></div>
                        <div><label for="themeTextColor">Цвет текста:</label><input type="color" id="themeTextColor" class="theme-color-input" value="#e53935"></div>
                        <div><label for="themeLinkColor">Цвет ссылок:</label><input type="color" id="themeLinkColor" class="theme-color-input" value="#e53935"></div>
                    </div>
                ...
                <div class="fp-tools-page-content" data-page="effects">
                    ...
                    <div class="template-container color-input-grid"><div><label for="cursorFxColor1">Цвет 1:</label><input type="color" id="cursorFxColor1" class="theme-color-input" value="#FF6B6B"></div><div><label for="cursorFxColor2">Цвет 2 (градиент):</label><input type="color" id="cursorFxColor2" class="theme-color-input" value="#e53935"></div></div>
                ...
                <div class="fp-tools-page-content" data-page="ai_audit">
                    ...
                    <div id="fp-audit-survey" style="display:none;">
                        ...
                        <div style="height:4px;background:var(--fptm-surface, #1e2030);border-radius:2px;margin-bottom:16px;overflow:hidden;">
                            <div id="fp-audit-progress-bar" style="height:100%;background:#e53935;width:0;transition:width .3s;border-radius:2px;"></div>
                        </div>
                ...
                <div class="fp-tools-page-content" data-page="settings_io">
                    ...
                    <div style="margin-top:24px;text-align:center;border-top:1px solid rgba(255,255,255,0.06);padding-top:16px;">
                        <a href="https://t.me/funpayfreetools" target="_blank" class="fp-site-footer-link"><span class="material-symbols-rounded" style="font-size:14px;vertical-align:-2px;margin-right:4px;">link</span>t.me/funpayfreetools</a>
                    </div>
                </div>
                ...
                <div class="fp-tools-page-content" data-page="tickets" style="position:relative;">
                    <style>
                        ...
                        .fp-tkt-card:hover{border-color:#e53935;background:var(--fptm-surface, #11122a);}
                        ...
                        .fp-field-input:focus{border-color:#e53935;}
                    ...
                    <div id="fp-ticket-detail-panel" style="display:none;position:absolute;inset:0;background:var(--fptm-surface, #111318);z-index:20;box-sizing:border-box;flex-direction:column;overflow:hidden;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',sans-serif;">
                        <style>
                            ...
                            #fp-tri{outline:none;caret-color:#e53935;background:var(--fptm-surface, #23243a) !important;border:none !important;box-shadow:none !important;border-radius:0 !important;padding:0 !important;margin:0 !important;}
                        ...
                        <div style="display:flex;align-items:center;gap:10px;padding:8px 12px;background:var(--fptm-surface, #1a1b22);flex-shrink:0;border-bottom:1px solid #0d0e14;">
                            <button id="fp-ticket-detail-back" style="all:unset;position:relative;overflow:hidden;color:#e53935;cursor:pointer;font-size:22px;line-height:1;padding:2px 6px 2px 0;flex-shrink:0;">&#8249;</button>
                            <div id="fp-tkt-av" style="width:32px;height:32px;border-radius:50%;background:var(--fptm-surface, #23243a);flex-shrink:0;display:flex;align-items:center;justify-content:center;font-size:12px;font-weight:700;color:#e53935;overflow:hidden;"></div>
                        ...
                        <div id="fp-tria" style="display:none;flex-shrink:0;align-items:flex-end;gap:6px;padding:6px 10px 8px;background:var(--fptm-surface, #111318);">
                            ...
                            <button id="fp-ticket-reply-btn" style="all:unset;position:relative;overflow:hidden;display:flex;align-items:center;justify-content:center;width:36px;height:36px;border-radius:50%;background:#e53935;cursor:pointer;flex-shrink:0;">
...
// FunPay (#e53935, тот же, что fallback в cloneSurfaceColors/ui_enhancements),
...
.fp-tools-popup.fptm-themed .btn.btn-secondary{
    background:var(--fptm-surface-2) !important; color:var(--fptm-text) !important; border:1px solid var(--fptm-border) !important;
}
...
function fptParseMenuColors() {
    ...
    // Акцент: фирменная голубая кнопка FunPay, иначе фирменный голубой #e53935.
    let accent = '';
...
function fptApplyMenuTheme(root) {
    ...
    try {
        ...
        // Множество старых правил используют var(--fpt-accent, #e53935) и прочие
...
const FP_THEME_GH_USER   = 'ismailtu3455-prog';
const FP_THEME_GH_REPO   = 'mybots';
...
const FP_THEME_INDEX_URL = FP_THEME_RAW_BASE + 'themes/index.json';
...
async function _fpLoadThemeCatalog() {
    ...
    // Подгружаем только личные темы пользователя (по желанию юзера глобальные отключены)
    const myNickEl = document.querySelector('.user-link-name');
    const myNick = myNickEl ? myNickEl.textContent.trim() : '';
    if (myNick) {
        try {
            const pResp = await fetch(FP_THEME_RAW_BASE + `themes/${encodeURIComponent(myNick)}/index.json`, { cache: 'no-store' });
            if (pResp.ok) {
                const pData = await pResp.json();
                const pList = Array.isArray(pData) ? pData : (Array.isArray(pData.themes) ? pData.themes : []);
                list = list.concat(pList);
            }
        } catch (e) {
            console.warn('Личные темы не найдены.', e);
        }
    }
    ...
    if (list.length === 0) {
        ...
        _fpThemeCatalog = list.filter(t => t && t.file).map(t => {
            const fileUrl = _fpThemeResolveUrl(t.file);
            return {
                name: t.name || 'Без названия',
                desc: t.desc || t.description || '',
                author: t.author || '',
                previewUrl: t.preview ? _fpThemeResolveUrl(t.preview) : fileUrl,
                fileUrl: fileUrl,
            };
        });
    }
...
async function initializeWallpaperPresets() {
    ...
    if (!_fpThemeCatalog.length) {
        if (slot) slot.innerHTML = '<div style="position:absolute;inset:0;display:flex;align-items:center;justify-content:center;color:var(--fptm-faint, #5a5f7a);font-size:12px;text-align:center;padding:10px;">Каталог пока пуст.<br>Темы добавляются через @funpayfreetoolsbot.</div>';
        if (loaderEl) loaderEl.style.display = 'none';
        return;
    }
...
async function applyThemeFromCatalog(theme) {
    ...
    try {
        let newTheme;
        const isJson = theme.fileUrl.toLowerCase().endsWith('.json') || theme.fileUrl.toLowerCase().endsWith('.fptheme');
        ...
        if (isJson) {
            ...
            newTheme = { ...data, enableCustomTheme: true };
        } else {
            const storage = await chrome.storage.local.get('fpToolsTheme');
            const fpToolsTheme = storage.fpToolsTheme || {};
            newTheme = { ...fpToolsTheme, bgImage: theme.fileUrl, enableCustomTheme: true };
        }
