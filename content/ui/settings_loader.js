...
async function renderTemplateSettings() {
    ...
    const createItem = (key, config, isCustom = false) => {
        ...
        const colorPickerHtml = `<input type="color" class="template-color-picker" value="${config.color || '#e53935'}" data-key="${key}" data-custom="${isCustom}">`;
...
async function loadSavedSettings() {
    ...
    const cursorFxDefaults = { enabled: false, type: 'sparkle', color1: '#FF6B6B', color2: '#e53935', rgb: false, count: 50 };
