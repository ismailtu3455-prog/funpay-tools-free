(function () {
    ...
    function showInlineChat(lot) {
        ...
        panel.innerHTML = `
            ...
            <div style="padding:10px 14px;">
                ...
                <div style="display:flex;gap:8px;margin-top:8px;">
                    <button id="fp-ctx-chat-send" style="flex:1;background:#e53935;color:#fff;border:none;border-radius:6px;padding:9px;font-size:13px;font-weight:600;cursor:pointer;">Отправить</button>
        ...
        sendBt.addEventListener('mouseleave', () => sendBt.style.background = '#e53935');
    ...
    function renderPinnedInTable() {
        ...
        pinnedLots.forEach(lot => {
            ...
            row.style.cssText = 'display:flex;align-items:center;padding:8px 12px;background:rgba(27,117,187,0.06);border-left:2px solid #e53935;';
            ...
            if (origRow) {
                ...
                clone.style.cssText = 'border-left:2px solid #e53935;background:rgba(27,117,187,0.05);';
